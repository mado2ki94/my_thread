...
class MyThreadsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create my_thread" do
    assert_difference('MyThread.count') do
      post my_threads_url, params: { my_thread: { string: @my_thread.string, title: @my_thread.title } }
    end
  ...
  test "should update my_thread" do
    patch my_thread_url(@my_thread), params: { my_thread: { string: @my_thread.string, title: @my_thread.title } }
